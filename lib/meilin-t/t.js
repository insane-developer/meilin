            ...
            this.templates = {
                bemjson: function(bemjson){
                    ...
                    if(bemjson instanceof Object){
                        ...
                        var id = bemjson.block || parent.block,
                            res = bemjson;
                        if(bemjson.elem){
...
module.exports = {
    ...
    bem: {
        buildBEMClassnames: proto.bem.buildBEMClassnames.bind(proto.bem),
        buildBEMEntity: proto.bem.buildBEMEntity.bind(proto.bem)/*,

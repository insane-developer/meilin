...
test('inheritance', function(){
    ...
    var generator = t.getGenerator('inheritance#1'),
        view = generator.getView();
    generator('name', 'I am no one');
    generator('job', 'nope');
    generator('bemlist', function(){
        return [
            'name: ',
            {
                block: 'name'
    ...
    var generator2 = t.getGenerator('inheritance#2', 'inheritance#1'),
    ...
    equal(view2('bemjson', {
        block: 'bemlist'
    }), 'name: I am no one, job: To tell anyone, that I am no one', 'Bem inheritance');
    expect(4);
